...
public class TC33 {
    ...
    public void T33() throws InterruptedException {
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath("//*[@id=\"__next\"]/div[1]/div/div/div/div/input")).sendKeys("예약");
        Thread.sleep(1300);
        ...
        driver.findElement(By.xpath("/html/body/div[2]/div[3]/div[1]/div[2]/div[1]/div[3]/div[2]/button[2]")).click();
        Thread.sleep(1000);
