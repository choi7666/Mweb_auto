...
public class TC16 {
        ...
        public void TC16() throws InterruptedException {
                ...
                Assert.assertEquals("Coming Soon\n" +
                        "커밍순", driver.findElement(By.xpath("//*[@id=\"container\"]/div/div[2]/div[1]/div[2]/a/div[1]/div/div[1]")).getText());
                ...
                WebElement product16a = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"__next\"]/div[3]/div[2]/dl[2]/dd/p")));
                Assert.assertEquals("커밍순", driver.findElement(By.xpath("//*[@id=\"__next\"]/div[3]/div[2]/dl[2]/dd/p")).getText());
                ...
                keywordinput17_btn.sendKeys("[자동화] 커밍x");
                ...
                // 품절 문구 미노출
                WebElement commingsoon2 = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"container\"]/div/div[2]/div[1]/div[2]/a/div[1]/div/div[1]/strong")));
                Assert.assertEquals("Coming Soon", driver.findElement(By.xpath("//*[@id=\"container\"]/div/div[2]/div[1]/div[2]/a/div[1]/div/div[1]/strong")).getText());
                ...
                Thread.sleep(800);
                WebElement cart16a_btn = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"__next\"]/ul/li[2]/div/div/div[1]/p[2]")));
                Assert.assertEquals("커밍순", driver.findElement(By.xpath("//*[@id=\"__next\"]/ul/li[2]/div/div/div[1]/p[2]")).getText());
