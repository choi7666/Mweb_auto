...
public class TC82_1 {
    ...
    public void TC82_1 () throws InterruptedException {
        ...
        // 아이디 입력
        driver.findElement(By.xpath("//*[@id=\"__next\"]/div[3]/form/div[2]/div[1]/div/input")).sendKeys("webauto1");
        Thread.sleep(500);

        // 패스워드 입력
        driver.findElement(By.xpath("//*[@id=\"__next\"]/div[3]/form/div[2]/div[2]/div/input")).sendKeys("testtest00");
        Thread.sleep(500);
