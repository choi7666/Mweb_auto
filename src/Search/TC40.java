...
public class TC40 {
    ...
    public void TC40() throws InterruptedException {
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath("//*[@id=\"__next\"]/div[1]/div/div/div/div/input")).sendKeys("q9000");
        Thread.sleep(1300);
        ...
        // 성인인증 스티커 확인
        Assert.assertEquals("19세성인인증", driver.findElement(By.xpath("//*[@id=\"container\"]/div/div[2]/div/div[1]/div/div")).getText());
