...
public class TC22_2 {
    ...
    @Test
    public void T22_2() throws InterruptedException {
        ...
        // 2cc 상품 할인 미적용 확인
        Assert.assertEquals("10,000원", driver.findElement(By.xpath("//*[@id=\"__next\"]/div[3]/div[1]/div[2]/div[2]")).getText());
        System.out.println("2CC 상품 할인 미적용 확인");
        Thread.sleep(1000);
