...
public class TC36 {
    ...
    public void TC36() throws InterruptedException {
        ...
        // 플레이스 홀더 확인
        WebElement serchtext = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"__next\"]/div[1]/div/div[3]/div/input")));
        Assert.assertEquals("", driver.findElement(By.xpath("//*[@id=\"__next\"]/div[1]/div/div[3]/div/input")).getText());
        System.out.println("검색어 플레이스 홀더 문구 확인");
