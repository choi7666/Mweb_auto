...
public class TC20 {
    ...
    @Test
    public void T20() throws InterruptedException {
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath("//*[@id=\"__next\"]/div[1]/div/div/div/div/input")).sendKeys("레고상품2");
        Thread.sleep(1300);
        ...
        Assert.assertEquals("30%7,000원", driver.findElement(By.xpath("//*[@id=\"__next\"]/div[3]/div[1]/div[2]/div[2]")).getText());
        ...
        // 정액 상품 확인
        Assert.assertEquals("레고상품2", driver.findElement(By.xpath("//*[@id=\"__next\"]/ul/li[1]/div/div/a")).getText());
