...
public class TC80_1 {
    ...
    @Test
    public void TC80_1() throws InterruptedException {
       ...
       // 장바구니 이동
        ...
        Thread.sleep(2000);
        Assert.assertEquals("이벤트 쿠폰이 유효하지 않습니다. 장바구니에서 아래 상품을 제외하고 다시 주문해주세요. ([자동화] 100원딜)", driver.findElement(By.xpath("//*[@id=\"swal2-content\"]/div[1]")).getText());
