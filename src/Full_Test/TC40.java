...
//mk-am14-008
        ...
        // 성인인증 스티커 확인
        WebElement serchadult_btn = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"container\"]/div/div[2]/div[1]/div[2]/a/div[1]/div/div[1]/span")));
        Assert.assertEquals("19세성인인증", driver.findElement(By.xpath("//*[@id=\"container\"]/div/div[2]/div[1]/div[2]/a/div[1]/div/div[1]/span")).getText());
        System.out.println("성인인증 스티커 확인");
        Thread.sleep(1000);
