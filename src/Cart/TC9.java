...
public class TC9 {
    ...
    public void TC9() throws InterruptedException {
        ...
        // 정액상품 판매가격
        Assert.assertEquals("10,000원", driver.findElement(By.xpath("//*[@id=\"__next\"]/ul/li[1]/div/div/div/div/span/span[2]")).getText());
        System.out.println("정액상품 판매가격 노출 확인");
        Thread.sleep(500);

        // 정액상품 할인가격
        Assert.assertEquals("7,000원", driver.findElement(By.xpath("//*[@id=\"__next\"]/ul/li[1]/div/div/div/div/span/span[1]")).getText());
